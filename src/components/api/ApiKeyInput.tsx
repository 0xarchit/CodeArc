    ...
    >
      <div className="flex min-h-full flex-col p-4">
        <div
          ...
          } m-auto p-8 rounded-xl shadow-lg max-w-md w-full relative`}
        >
          <button
          ...
          >
            ...
            >
              ...
              <br />
              We never store your API key on our servers. It is only upto your
              device.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-4 relative">
                  ...
                  <button
                    type="button"
                    className={`absolute right-0 top-0 -mt-6 p-1 rounded-full ${
                      isDarkMode
                ...
                {showTooltip && (
                  ...
                  >
                    This is for personalizing the AI's tone. No data will be
                    shared anywhere.
                  </div>
                )}
              </div>
